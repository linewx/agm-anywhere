    ...
    private void translate(Node node) {
        ...
        switch (node.type) {
            case VALUE:
                ...
                node.left = new Node(com.hp.alm.ali.translate.expr.Type.GTE, new Node(String.valueOf(value)));
                node.right = new Node(com.hp.alm.ali.translate.expr.Type.LT, new Node(String.valueOf(value + 1000)));
                node.type = com.hp.alm.ali.translate.expr.Type.AND;
                node.value = null;
                return;
            ...
            case EQ:
                ...
                node.left = new Node(com.hp.alm.ali.translate.expr.Type.GTE, new Node(String.valueOf(value)));
                node.right = new Node(com.hp.alm.ali.translate.expr.Type.LTE, new Node(String.valueOf(value + 999)));
                node.type = com.hp.alm.ali.translate.expr.Type.AND;
                node.value = null;
                return;
            ...
            case DIFFERS:
                value = resolveValue(node.left.value);
                node.left = new Node(com.hp.alm.ali.translate.expr.Type.LT, new Node(String.valueOf(value)));
                node.right = new Node(com.hp.alm.ali.translate.expr.Type.GTE, new Node(String.valueOf(value + 1000)));
                node.type = com.hp.alm.ali.translate.expr.Type.OR;
                node.value = null;
                return;
