package com.hp.saas.agm.app.view;
...
public class ExpandedTreeView extends ExpandableListView implements
        OnScrollListener, OnGroupClickListener {
	public ExpandedTreeView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public ExpandedTreeView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public ExpandedTreeView(Context context) {
		super(context);
		registerListener();
	}
	 ...
	 */
	public interface ExpandTreeHeaderAdapter {
	...
	private ExpandTreeHeaderAdapter mAdapter;
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		mAdapter = (ExpandTreeHeaderAdapter) adapter;
	}
	...
	public void configureHeaderView(int groupPosition, int childPosition) {
		...
		switch (state) {
		case ExpandTreeHeaderAdapter.PINNED_HEADER_GONE: {
			mHeaderViewVisible = false;
			break;
		}

		case ExpandTreeHeaderAdapter.PINNED_HEADER_VISIBLE: {
		...
		case ExpandTreeHeaderAdapter.PINNED_HEADER_PUSHED_UP: {
