...
package com.hp.saas.agm.core.model.type;

;

import java.util.regex.Matcher;
import java.util.regex.Pattern;
import com.hp.saas.agm.core.translate.Translator;
import com.hp.saas.agm.core.translate.ValueCallback;
import com.hp.saas.agm.core.filter.FilterFactory;
import com.hp.saas.agm.core.translate.filter.FilterResolver;
import com.hp.saas.agm.core.translate.expr.*;
    ...
    private void translate(Node node) {
        ...
        switch (node.type) {
            case VALUE:
                ...
                node.left = new Node(com.hp.saas.agm.core.translate.expr.Type.GTE, new Node(String.valueOf(value)));
                node.right = new Node(com.hp.saas.agm.core.translate.expr.Type.LT, new Node(String.valueOf(value + 1000)));
                node.type = com.hp.saas.agm.core.translate.expr.Type.AND;
                node.value = null;
                return;
            ...
            case EQ:
                ...
                node.left = new Node(com.hp.saas.agm.core.translate.expr.Type.GTE, new Node(String.valueOf(value)));
                node.right = new Node(com.hp.saas.agm.core.translate.expr.Type.LTE, new Node(String.valueOf(value + 999)));
                node.type = com.hp.saas.agm.core.translate.expr.Type.AND;
                node.value = null;
                return;
            ...
            case DIFFERS:
                value = resolveValue(node.left.value);
                node.left = new Node(com.hp.saas.agm.core.translate.expr.Type.LT, new Node(String.valueOf(value)));
                node.right = new Node(com.hp.saas.agm.core.translate.expr.Type.GTE, new Node(String.valueOf(value + 1000)));
                node.type = com.hp.saas.agm.core.translate.expr.Type.OR;
                node.value = null;
                return;
